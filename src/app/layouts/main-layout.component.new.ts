      ...
      <div class="bg-white p-4">
        <div class="flex items-center justify-between mb-8">
          <div class="flex items-center space-x-3">
            ...
            <h1 class="text-2xl font-bold text-gray-900">factos</h1>
          </div>
        ...
        <div class="flex bg-white rounded-lg p-1 shadow-sm border border-gray-200">
          <button 
            ...
            class="flex-1 flex items-center justify-center space-x-2 py-3 px-4 rounded-md font-medium transition-colors"
